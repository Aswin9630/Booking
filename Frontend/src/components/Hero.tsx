...
const Hero = () => {
  ...
  return (
    <div className="bg-neutral-50 shadow-2xl m-15 rounded-2xl">
       <h1 className="font-bold text-slate-100 text-3xl md:text-6xl text-center text-shadow-slate-900 text-shadow-lg">
          Find Your Perfect Stay
        </h1>
    <div className="p-5 md:p-8 lg:p-20">
      <div
        className="p-3 mt-3 md:p-10 bg-cover bg-center bg-no-repeat h-50 md:h-100 rounded-xl md:bg-cover md:bg-no-repeat w-full md:bg-center"
