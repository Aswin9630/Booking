...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="mt-5 p-3 lg:p-5 bg-black rounded-2xl md:rounded-2xl lg:rounded-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2 container mx-auto items-center"
    >
